...
export class AgentSessionClient {
	...
	private readonly sessionListeners = new Map<string, Set<(event: AgentSessionSyncEvent) => void>>();
	private readonly globalListeners = new Set<(event: GlobalServerEvent) => void>();
