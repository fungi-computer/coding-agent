...
const isValidThinkingLevel = (level: string): level is ThinkingLevel =>
  VALID_THINKING_LEVELS.includes(level as ThinkingLevel);
...
export const defaultModelPerProvider: Record<KnownProvider, string> = {
  ...
  "qwen-token-plan": "qwen-coder-plus-latest",
  "qwen-token-plan-cn": "qwen-coder-plus-latest",
  radius: "radius",
